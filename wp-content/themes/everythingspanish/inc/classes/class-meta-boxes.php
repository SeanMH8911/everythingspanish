...
class Meta_Boxes {
	...
	public function add_custom_meta_box() {
		...
		foreach ( $screens as $screen ) {
			add_meta_box(
				...
				__( 'Hide page title', 'everythingspanish' ),  // Box title
	...
	public function custom_meta_box_html( $post ) {
		...
		?>
		<label for="everythingspanish-field"><?php esc_html_e( 'Hide the page title', 'everythingspanish' ); ?></label>
		<select name="everythingspanish_hide_title_field" id="everythingspanish-field" class="postbox">
			<option value=""><?php esc_html_e( 'Select', 'everythingspanish' ); ?></option>
			<option value="yes" <?php selected( $value, 'yes' ); ?>>
				<?php esc_html_e( 'Yes', 'everythingspanish' ); ?>
			</option>
			<option value="no" <?php selected( $value, 'no' ); ?>>
				<?php esc_html_e( 'No', 'everythingspanish' ); ?>
			</option>
		</select>
		<?php
	}
	...
	public function save_post_meta_data( $post_id ) {
		...
		if ( array_key_exists( 'everythingspanish_hide_title_field', $_POST ) ) {
			update_post_meta(
				$post_id,
				'_hide_page_title',
				$_POST['everythingspanish_hide_title_field']
			);
		}
	}
