 ...
 * Cover Patterns
 *
 * @package package EverythingSpanish
 */

?>

<!-- wp:cover {"url":"<?php echo esc_url( EVERYTHINGSPANISH_BUILD_IMG_URI . '/patterns/madrid.jpg' ) ?>","id":3854,"minHeight":640,"align":"full","className":"everythingspanish-cover"} -->
<div class="wp-block-cover alignfull has-background-dim everythingspanish-cover" style="background-image:url(<?php echo esc_url( EVERYTHINGSPANISH_BUILD_IMG_URI . '/patterns/madrid.jpg' ) ?>);min-height:640px"><div class="wp-block-cover__inner-container"><!-- wp:heading {"align":"center","level":1} -->
